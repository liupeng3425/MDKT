...
class UDADecorator(BaseSegmentor):
    ...
    def __init__(self, **cfg):
        super(UDADecorator, self).__init__()
    ...
    def forward_train(self,
        ...
        losses = self.get_model().forward_train(
            img, img_metas, gt_semantic_seg, return_feat=return_feat, **kwargs)
        return losses
    ...
    def simple_test(self, img, img_meta, rescale=True, **kwargs):
        ...
        return self.get_model().simple_test(img, img_meta, rescale, **kwargs)
